...
#   Your task is to read the input file line by line and take first 50 lines from it and copy first that 
#   first 50 lines to a new file called op_text_code.txt inside the new folder called OUTPUT.
# Python Version : 3.7
############################################################################################################
